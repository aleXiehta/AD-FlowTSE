...
class UDiT(nn.Module):
    ...
    def forward(self, x, t, enrollment):
        ...
        x = self.final_layer(x, t)                # (N, T, out_dim)
        x = x.transpose(2, 1)
...
if __name__ == "__main__":
    with open('/mnt/train1/tahsieh/SoloAudio/config/SoloAudio.yaml', 'r') as fp:
    ...
    ref = torch.rand((8, 128, 150)).to(device)
    t = torch.randint(0, 1000, (8, )).long().to(device)
    mix = torch.rand((8, 128, 150)).to(device)
